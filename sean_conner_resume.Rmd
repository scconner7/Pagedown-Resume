...
- Develop and maintain an internal R package for the modularization of strategic analyses, creation / database upload of net rate matrices, and bulk, cross-customer exception management.
...
- Assisted with survey questionnaire construction, sampling, and presentations of findings.
...
- Most Valuable Player (MVP) Award, nominated by peers and chosen by senior leadership for 1 of only 2 such awards company-wide each year (2022).
...
- President of the Senate for University of MS Model Senate (Fall 2013).
